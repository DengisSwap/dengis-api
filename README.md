# Dengis Exchange API Documentation
...
The Dengis Exchange API provides developers with direct access to our decentralized exchange infrastructure built on the Solana blockchain. Our API offers the best rates and lowest slippage for token swaps.
...
To get started with the Dengis Exchange API:
...
```bash
curl https://api.dengis.xyz/v1/tokens
```
...
```bash
curl "https://api.dengis.xyz/v1/swap/quote?inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=1000000000&slippageBps=50"
```
...
```bash
curl "https://api.dengis.xyz/v1/price?ids=So11111111111111111111111111111111111111112,EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
```
...
ws.onopen = () => {
  console.log('Connected to Dengis Exchange');
...
- **Website:** [https://dengis.xyz](https://dengis.xyz)
- **GitHub:** [https://github.com/dengisswap/dengis-api](https://github.com/dengisswap/dengis-api)
- **Twitter:** [https://x.com/dengisswap](https://x.com/dengisswap)

## Support

For support, questions, or feature requests:

- Open an issue on [GitHub](https://github.com/dengisswap/dengis-api)
- Follow us on [Twitter](https://x.com/dengisswap)
- Visit our website at [dengis.xyz](https://dengis.xyz)
